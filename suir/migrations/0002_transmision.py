    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo', models.TextField(blank=True, help_text='Código Embed < > de YouTube.', null=True, validators=[django.core.validators.RegexValidator(message='El campo debe contener el código <embed> de YouTube.', regex='<iframe')], verbose_name='Codigo de YouTube')),
